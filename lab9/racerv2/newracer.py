...
W, H = 1000, 1000
pg.display.set_caption("Игра на двоих")
clock = pg.time.Clock()

bgRoad = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/bgRoad.jpg")
sharkIm = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/shark.png")
rocketIm = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/rocket.png")
bombIm = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/bomb.png")
...
class Cherry(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/cherry.png")
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/coin.png")
        self.rect = self.image.get_rect()
        self.speed = 7
    def move(self):
        global money
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/bomb.png")
        self.rect = self.image.get_rect()
...
class Shark(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/shark.png")
        self.rect = self.image.get_rect()
...
pg.mixer.music.load("C:/Users/Nurbek/Desktop/pp2/lab9/racerv2/Initial D - Deja Vu.mp3")
pg.mixer.music.play()
