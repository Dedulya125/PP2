...
bg = pygame.image.load('/Users/Nurbek/Desktop/pp2/lab7/clock/images/mickey-clock.jpg')
BG_WIDTH = 500
BG_HEIGHT = 500
BG_X_POS = (SCREEN_WIDTH / 2 - BG_WIDTH / 2)
BG_Y_POS = (SCREEN_HEIGHT / 2 - BG_HEIGHT / 2)

big_arrow = pygame.image.load('/Users/Nurbek/Desktop/pp2/lab7/clock/images/big-arrow.png')
BIG_ARROW_WIDTH = 35
...
small_arrow = pygame.image.load('/Users/Nurbek/Desktop/pp2/lab7/clock/images/small-arrow.png')
